...
Java_com_rtmpx_library_rtmp_RtmpClient_nativeAlloc(JNIEnv* env, jobject thiz) {
...
Java_com_rtmpx_library_rtmp_RtmpClient_nativeOpen(JNIEnv* env, jobject thiz, jstring url_,
 ...
 */
JNIEXPORT jint JNICALL
Java_com_rtmpx_library_rtmp_RtmpClient_nativeRead(JNIEnv* env, jobject thiz, jbyteArray data_,
 ...
 */
JNIEXPORT jint JNICALL
Java_com_rtmpx_library_rtmp_RtmpClient_nativeWrite(JNIEnv* env, jobject thiz, jbyteArray data,
                                                         jint offset, jint size, jlong rtmpPointer) {
 ...
 */
JNIEXPORT jint JNICALL
Java_com_rtmpx_library_rtmp_RtmpClient_seek(JNIEnv* env, jobject thiz, jint seekTime) {
    return 0;
}
 ...
 */
JNIEXPORT jint JNICALL
Java_com_rtmpx_library_rtmp_RtmpClient_nativePause(JNIEnv* env, jobject thiz, jboolean pause,
                                                         jlong rtmpPointer) {
...
Java_com_rtmpx_library_rtmp_RtmpClient_nativeClose(JNIEnv* env, jobject thiz, jlong rtmpPointer) {
...
Java_com_rtmpx_library_rtmp_RtmpClient_nativeIsConnected(JNIEnv* env, jobject thiz, jlong rtmpPointer) {
    RTMP *rtmp = (RTMP *) rtmpPointer;
    if (rtmp == NULL) {
        return false;
    }
